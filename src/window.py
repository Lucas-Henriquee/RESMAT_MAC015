...
def create_main_screen(window, frame):
    ...
    create_button(
        frame, "Atividade 03", 
        ("Arial", 16, "bold"), "#ff9800", "white", lambda: messagebox.showinfo("Em Breve!", "Estamos trabalhando para disponibilizar essa atividade em breve!"), #create_main_screen_activity_03(window, frame),
        button_width, 2, pady=button_spacing
    )
